...
const { getDeviceData, getActiveDevices, updateGeofence, uploadBleTelemetry } = require('../controllers/tracker-controller.js');
...
router.put('/StudentsAttendanceBulk', studentAttendanceBulk)
