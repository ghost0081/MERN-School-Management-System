...
def deploy():
    ...
    sftp = ssh.open_sftp()
    print("Uploading backend models, controllers, and routes...")
    sftp.put(r"D:\coding\crm-school\MERN-School-Management-System\backend\models\studentSchema.js",
             "/root/school-backend/models/studentSchema.js")
    sftp.put(r"D:\coding\crm-school\MERN-School-Management-System\backend\controllers\tracker-controller.js",
             "/root/school-backend/controllers/tracker-controller.js")
    sftp.put(r"D:\coding\crm-school\MERN-School-Management-System\backend\routes\route.js",
             "/root/school-backend/routes/route.js")
    ...
    ssh.close()
    print("GEOFENCE SAFE ZONE DEPLOYMENT COMPLETE!")
